"""Tests for the Freeverb reverb implementation."""
...
from freeverb import AllpassFilter, CombFilter, Freeverb, apply_reverb
...
class TestAllpassFilter:
    def test_bounded_energy(self):
        ...
        # Freeverb's allpass is not strictly unit-gain; allow up to 5x energy
...
class TestFreeverb:
    ...
    def test_dry_only_preserves_input(self):
        ...
        result = Freeverb(wet=0.0, dry=1.0).process(mono)
    ...
    def test_stereo_width_zero_gives_mono_reverb(self):
        ...
        impulse[0] = 0.5
        result = Freeverb(wet=1.0, dry=0.0, width=0.0).process(impulse)
