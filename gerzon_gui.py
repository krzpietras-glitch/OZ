#!/usr/bin/env python3
"""Tkinter GUI for the Gerzon Reverb processor."""
...
class GerzonGUI(tk.Tk):
    """Main application window."""

    def __init__(self) -> None:
        super().__init__()
        self.title("Gerzon Reverb")
    ...
    def _build_ui(self) -> None:
        ...
        params = [
            ...
            ("modulation_depth", "Mod Depth", DEFAULT_MODULATION_DEPTH),
            ("modulation_rate", "Mod Rate", DEFAULT_MODULATION_RATE),
            ("wet", "Wet", DEFAULT_WET),
            ("dry", "Dry", DEFAULT_DRY),
    ...
    def _apply_worker(self, input_path: str, output_path: str, params: dict) -> None:
        try:
            apply_reverb(
                ...
                modulation_rate=params["modulation_rate"],
                wet=params["wet"],
                dry=params["dry"],
                width=params["width"],
            )
