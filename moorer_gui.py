#!/usr/bin/env python3
"""Tkinter GUI for the Moorer reverb processor."""
...
class MoorerGUI(tk.Tk):
    """Main application window."""

    def __init__(self) -> None:
        super().__init__()
        self.title("Moorer Reverb")
    ...
    def _build_ui(self) -> None:
        ...
        params = [
            ...
            ("early_reflections", "Early Refl.", DEFAULT_EARLY_REFLECTIONS),
            ("wet", "Wet", DEFAULT_WET),
            ("dry", "Dry", DEFAULT_DRY),
    ...
    def _apply_worker(self, input_path: str, output_path: str, params: dict) -> None:
        try:
            apply_reverb(
                ...
                early_reflections=params["early_reflections"],
                wet=params["wet"],
                dry=params["dry"],
                width=params["width"],
            )
